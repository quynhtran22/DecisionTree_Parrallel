...
//                    //MPI_Send(&gain, 1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD);
//                    continue;
//                }
...
//                    //gain = 0; // stop if small gain
//                //MPI_Send(&gain, 1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD);
//                if (gain > bestLocalGain) {
//                    bestLocalGain = gain;
//                    bestLocalAttr = i;
//                }
//            }
...
//        double result[2];
//        if (rank > 0) {
//            result[0] = bestLocalGain;
//            result[1] = bestLocalAttr;
//            MPI_Send(&result, 2, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD);
//        }
//
//        double bestGain = bestLocalGain;
//        int bestAttribute = bestLocalAttr;
//        vector<int> order;
...
//            //for (int i = 0; i < 6; i++) {
//            //    double gain;
//            //    MPI_Recv(&gain, 1, MPI_DOUBLE, i+1, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
//            //    if (gain > bestGain) {
//            //        bestGain = gain;
//            //        bestAttribute = i;
//            //    }
//            //}
//
//            double resultRank1[2], resultRank2[2];
//            MPI_Recv(&resultRank1, 2, MPI_DOUBLE, 1, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
//            MPI_Recv(&resultRank2, 2, MPI_DOUBLE, 2, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
//            if (bestGain < resultRank1[0]) {
//                bestGain = resultRank1[0], bestAttribute = resultRank1[1];
//            }
//            if (bestGain < resultRank2[0]) {
//                bestGain = resultRank2[0], bestAttribute = resultRank2[1];
//            }
//            for (int i = 1; i <= 2; i++) {
